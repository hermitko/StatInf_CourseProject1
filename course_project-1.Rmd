...
the Law of large numbers in backpack we are pretty sure, that 40,000 samples -- 40 for each
...
density in any case fully. As far as author can say -- from the included plot is apparent,
that the approximation with normal density is pretty accurate (in the sense of the density
curve). But the proper analysis of this is beyond the scope of this little document (and
